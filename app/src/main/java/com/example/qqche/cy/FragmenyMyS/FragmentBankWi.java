...
public class FragmentBankWi extends AppCompatActivity implements TextWatcher {
...
//    TextView toolbarTitle;
    @BindView(R.id.my_back_1)
    TextView myBack1;
    @BindView(R.id.my_back_one)
    LinearLayout myBackOne;
...
//    TextView WiTitleButton;
    ...
    private static  class MyHandler extends Handler{
        private WeakReference<FragmentBankWi> weakReference;
        public  MyHandler(FragmentBankWi activity) {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_my_bank_exist);
