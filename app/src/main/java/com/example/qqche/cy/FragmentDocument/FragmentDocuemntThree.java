...
public class FragmentDocuemntThree extends AppCompatActivity {
    ...
    private static class MyHandler extends Handler {
        private WeakReference<FragmentDocuemntThree> weakReference;

        public MyHandler(FragmentDocuemntThree activity) {
