...
public class HotPostAdapter extends XRecyclerView.Adapter<HotPostAdapter.ViewHolder> {
    ...
    public HotPostAdapter(List<Commend> commends){
        mCommend = commends;
    }
    @NonNull
    @Override
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.information_hot_post,parent,false);
