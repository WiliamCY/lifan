...
public class InforMationMoneyAdapter extends XRecyclerView.Adapter<InforMationMoneyAdapter.ViewHolder> {
    ...
    static  class ViewHolder extends  XRecyclerView.ViewHolder{
        ...
        public ViewHolder(View view) {
            super(view);
            commendH1  = view.findViewById(R.id.infomation_h1);
            commendH2  = view.findViewById(R.id.infomation_h2);
            commendH3 = view.findViewById(R.id.infomation_h3);
            commendH4 = view.findViewById(R.id.infomation_h4);
            commendImage = view.findViewById(R.id.infomation_image);
        }
    }
    public InforMationMoneyAdapter(List<Commend> commends){
        mCommend = commends;
    }
    @NonNull
    @Override
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.infomation_money,parent,false);
