...
public class FragmentDocuemntTwo extends AppCompatActivity {
    ...
    private static class MyHandler extends Handler {
        private WeakReference<FragmentDocuemntTwo> weakReference;

        public MyHandler(FragmentDocuemntTwo activity) {
